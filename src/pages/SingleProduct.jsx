...
const SingleProduct = () => {
	...
	return (
		<section >
			...
			{/* PRODUCT */}
			<div className='mt-6 grid gap-y-8 lg:grid-cols-2 lg: gap-x-16 place-items-center'>
				{/* IMAGE */}
				...
				<div>
					...
					<div>
						<div className="form-control w-full max-w-xs">
							...
							<select className='select select-secondary select-bordered select-md' id="amount" value={amount}
